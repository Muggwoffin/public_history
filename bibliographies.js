/**
 * Bibliographies Data
 * Curated, annotated reading lists rendered by bibliography-renderer.js on
 * bibliography.html (selected via ?slug=). Add another object to publish a
 * new bibliography; link to it from the Tools page via resources.js.
 *
 * Citations are normalised to a consistent style (Author. Title. Place:
 * Publisher, Year.); obvious export artefacts have been cleaned up.
 */

const bibliographies = [
    {
        "slug": "comintern-memoirs",
        "title": "Comintern-Era Memoirs & Autobiographies",
        "subtitle": "International activists in the Soviet Union, 1919–1943 — a working bibliography",
        "intro": [
            ...
            "This list is focused on works originally published in English or available in translation although I am open to suggestions of works in other languages.",
            "Researchers will know that many of the authors listed below (both the lifelong communists and ex-communists) had axes to grind. The usual provisos about unreliable narrators apply. In particular, Krebs' Out of the Night is a highly unreliable work - though I have kept it on the list as an atmospheric work perhaps best described as Comintern fiction."
        ],
        "sections": [
            {
                "title": "I. Published Autobiographies/Memoirs",
                "entries": [
                    ...
                    "Beal, Fred Erwin. Proletarian Journey: New England, Gastonia, Moscow. New York: Da Capo Press, 1971.",
                    ...
                    "Bonner, Elena. Mothers and Daughters. Vintage, 1993.",
                    "Borghi, Armando. Vivere da anarchico. 1966.",
                    ...
                    "de Bellmunt, Domènec. 'El Català de l'URSS (Biografia d'Andreu Nin).' Homes de la Terra, 1935.",
                    "Damodaran, K. 'Memoir of an Indian Communist.' New Left Review 1:93 (Sept–Oct 1975).",
                    "Dash, Jack. Good Morning Brothers! London, 1969.",
                    "Dennis, Peggy. The Autobiography of an American Communist. Westport: Lawrence Hill & Co., 1977.",
                    "Dewar, Margaret. The Quiet Revolutionary: The Autobiography of Margaret Dewar. London: Bookmarks, 1989.",
                    "Dimitrov, Georgi. The Diary of Georgi Dimitrov, 1933–1949. Edited by Ivo Banac. New Haven: Yale University Press, 2018.",
                    "Drachkovitch, Milorad, and Branko Lazić. The Comintern: Historical Highlights, Essays, Recollections, Documents. Stanford, 1966.",
                    "Erenburg, Ilya. Memoirs: 1921–1941. New York: Grosset & Dunlap, 1966.",
                    ...
                    "Fischer, Markoosha. My Lives in Russia. New York: Harper & Brothers, 1944.",
                    ...
                    "Herrick, William. Jumping the Line: The Adventures and Misadventures of an American Radical. University of Wisconsin Press, 1998.",
                    "Hobsbawm, E. J. Interesting Times: A Twentieth-Century Life. London: Abacus, 2010.",
                    "Hoelz, Max. Vom „Weißen Kreuz“ zur Roten Fahne: Jugend-, Kampf- und Zuchthauserlebnisse. Berlin, 1929; reprint Frankfurt/M, 1969.",
                    "Hümbelin, Lotte. Mein eigener Kopf: ein Frauenleben in Wien, Moskau, Prag, Paris, Zürich. Zürich, 1999.",
                    "Huppert, Hugo, and Martin Reso. Einmal Moskau und zurück: Stationen meiner Autobiographie. Wien: Globus Verlag, 1987.",
                    ...
                    "Jung, Franz. Der Weg nach unten: Aufzeichnungen aus einer großen Zeit. Berlin, 1961; republished 1988.",
                    ...
                    "Kolman, Ernest. My Ne Dolzhny Byli tak Zhit'. New York, 1982 (in Russian).",
                    "Kramer, Hilde. Rebellin in München, Moskau und Berlin: Autobiographisches Fragment, 1900–1924. Edited by Egon Günther and Thies Marsen. Berlin, 2011.",
                    ...
                    "Leder, Mary, and Laurie Bernstein. My Life in Stalinist Russia: An American Woman Looks Back. Bloomington: Indiana University Press, 2002.",
                    "León, María Teresa. Memoria de la melancolía. Edited by Gregorio Torres Nebrera. Madrid: Editorial Castalia, 1999.",
                    ...
                    "McKay, Claude. A Long Way from Home. New York, 1937; republished New Brunswick: Rutgers University Press, 2007.",
                    "Mendel, Hersh. Memoirs of a Jewish Revolutionary. London: Pluto Press, 1989.",
                    "Meyer-Leviné, Rosa. Inside German Communism: Memoirs of Party Life in the Weimar Republic. London, 1977.",
                    ...
                    "Retzlaw, Karl. Spartacus: Aufstieg und Niedergang. Erinnerungen eines Parteiarbeiters. 1985.",
                    ...
                    "Stewart, Bob. Breaking the Fetters: The Memoirs of Bob Stewart. London: Lawrence & Wishart, 1967.",
                    "Strong, Anna Louise. I Change Worlds. London: G. Routledge and Sons, 1935.",
                    "———. Red Star in Samarkand. London, 1930.",
                    "Szurek, Aleksander. The Shattered Dream. Translated by Hilda R. Grunblatt and Jacques Grunblatt. Boulder; New York: Columbia University Press, 1989.",
                    "Thorez, Maurice. Son of the People. New York: International Publishers, 1938.",
                    "Trepper, Leopold. The Great Game: The Story of the Red Orchestra. London, 1979.",
                    "Tuominen, Arvo. The Bells of the Kremlin: An Experience in Communism. London, 1983.",
                    "Usmani, Shaukat. Historic Trips of a Revolutionary: Sojourn in the Soviet Union. New Delhi: Sterling Publishers, 1977.",
                    ...
                    "Wicks, Harry. Keeping My Head: The Memoirs of a British Bolshevik. London: Socialist Platform, 1992.",
                    "Ypsilon. Pattern for World Revolution. Chicago; New York: Ziff-Davis, 1947.",
                    "Zhang, Guotao. The Rise of the Chinese Communist Party, 1928–1938. Lawrence: University Press of Kansas, 1972."
                ]
            },
            {
                "title": "II. Unpublished Memoirs, Archival Material and Relevant Resources",
                "entries": [
                    ...
                    "Jeifets, Víctor. La Internacional Comunista y América Latina, 1919–1943: Diccionario Biográfico. (A very useful biographical dictionary for Spanish speakers, available as an Open Access PDF.)",
                    ...
                    "Papers of S. P. Bunting, founder of the South African CP and attendee at the 6th Comintern Congress."
                ]
            }
        ],
        "acknowledgements": "In no particular order, thanks to Brigid O'Keeffe, Michael D. Gordin, Evan Smith, Daryl Leeworthy, Marc Mulholland, Hannah Proctor, Owen Hatherley, Fraser Raeburn, Arturo Rodríguez, Mark Rosen, Dean Dettloff, Claire Roosien and Geoff Robinson for pointing me towards books I would not have found otherwise!"
    }
];
